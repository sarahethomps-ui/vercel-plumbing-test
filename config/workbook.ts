...
export const STEPS: WorkbookStep[] = [
  {
    ...
    fields: [
      ...
      {
        id: "q1_problem_explain",
        label: "Explain the frictions in your experience.",
        type: "longText",
        placeholder: "Enter your response…",
      },
      {
      ...
      {
        id: "q1_solution_explain",
        label: "Explain how AI will address the friction in your experience.",
        type: "longText",
        placeholder: "Enter your response…",
      },
      {
